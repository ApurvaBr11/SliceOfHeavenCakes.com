...
const CallToAction = () => {
  return (
    <div className="h-[600px] flex justify-center items-center relative">
      <div className="md:h-32 md:w-32 h-16 w-16 rounded-full overflow-hidden flex justify-center items-center absolute top-32 left-20">
        <img
          className="scale-150"
      ...
      <div className="md:h-32 md:w-32 h-16 w-16 rounded-full overflow-hidden flex justify-center items-center absolute top-32 right-20">
        <img
          className=""
      ...
      <div className="md:h-44 md:w-44 h-32 w-32  rounded-full overflow-hidden flex justify-center items-center absolute bottom-36 right-44">
        <img
          className=""
      ...
      <div className="md:h-44 md:w-44 h-32 w-32  rounded-full overflow-hidden flex justify-center items-center absolute bottom-32 left-48">
        <img
          className="scale-150"
      ...
      <div className="text-center text-5xl font-bold leading-normal md:z-0 z-20">
